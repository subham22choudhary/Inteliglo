...
const LIMITS = {
    principal: { min: 50000, max: 5000000, step: 10000 },
    rate: { min: 7, max: 16, step: 0.1 },
    tenureYears: { min: 1, max: 8, step: 0.5 },
};
    ...
    return (
        <div className="ig">
            <div className="ig-inner" style={{ maxWidth: 820, textAlign: "left" }}>
                ...
                <h1 style={{ textAlign: "center" }}>Car Loan EMI Calculator</h1>

                <FieldWithSlider label="Car Loan Amount" prefix="₹" value={principal} onChange={setPrincipal} limits={LIMITS.principal} />
                ...
                <p style={disclaimerStyle}>
                    Estimates only. Actual car loan rates depend on new vs used vehicle, down payment,
                    lender, and your credit profile — check with your bank or dealer for exact figures.
                </p>
            </div>
        </div>
    );
