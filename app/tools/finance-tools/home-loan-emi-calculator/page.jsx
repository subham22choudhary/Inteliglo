...
const LIMITS = {
    principal: { min: 500000, max: 30000000, step: 50000 },
    rate: { min: 6, max: 15, step: 0.05 },
    ...
    return (
        <div className="ig">
            <div className="ig-inner" style={{ maxWidth: 820, textAlign: "left" }}>
                ...
                <h1 style={{ textAlign: "center" }}>Home Loan EMI Calculator</h1>

                <FieldWithSlider label="Home Loan Amount" prefix="₹" value={principal} onChange={setPrincipal} limits={LIMITS.principal} />
                ...
                <p style={disclaimerStyle}>
                    Estimates only. Actual home loan rates depend on your lender, credit score, loan-to-value
                    ratio, and processing fees — check with your bank for exact figures.
                </p>
            </div>
        </div>
    );
