  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-white mb-4">
              AI-powered digital marketing solutions for modern businesses.
            </p>
        ...
        <div className="pt-8 border-t-2 border-transparent flex flex-col md:flex-row justify-between items-center gap-4"
          style={{
            borderImage: 'linear-gradient(90deg, #a855f7, #06b6d4) 1'
          }}
        >
          <p className="text-white text-sm">
            © 2025 Digital Marketing Company. All rights reserved.
          </p>
